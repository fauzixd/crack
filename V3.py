...
for xd in range(10000):
	...
	g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.88'
...
def login_lagi334():
	try:
		...
		ken=open(".token1.txt", "w").write(find_token.group(1));
	...
	for pw in pwv:
		try:
			...
			#	os.popen('play-audio data/cp.mp3')
				...
				headapp={"Mozilla/5.0 (Linux; Android 9; Infinix X653C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.116 Mobile Safari/537.36"}
				if 'no' in taplikasi:
					ok+=1
